 ...
 ***************************************************************** */
{
  ...
  double ***interBound;
    ...
    double ***vr_corr_r, ***vr_corr_z;
    double ***vz_corr_r, ***vz_corr_z;
  ...
  // export T and mu ne and ionization degree
    ...
    *d_corrected_z = *d;
    ...
    // I take the corrected vr, vz, rho
    vr_corr_r = GetUserVar("vr_corr_r");
    vr_corr_z = GetUserVar("vr_corr_z");
    vz_corr_r = GetUserVar("vz_corr_r");
    vz_corr_z = GetUserVar("vz_corr_z");
    rho_corr_z = GetUserVar("rho_corr_z");
    rho_corr_r = GetUserVar("rho_corr_r");
    DOM_LOOP(k,j,i){
      vr_corr_r[k][j][i] = d_corrected_r->Vc[iVR][k][j][i];
      vr_corr_z[k][j][i] = d_corrected_z->Vc[iVR][k][j][i];
      vz_corr_r[k][j][i] = d_corrected_r->Vc[iVZ][k][j][i];
      vz_corr_z[k][j][i] = d_corrected_z->Vc[iVZ]][k][j][i];

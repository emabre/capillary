...
#if THERMAL_CONDUCTION==ALTERNATING_DIRECTION_IMPLICIT && RESISTIVITY==ALTERNATING_DIRECTION_IMPLICIT
  #define TDIFF 0
  #define BDIFF 1
  #define NBCS  2
...
typedef struct BCS{
  ...
  double bc_values[NBCS][2];   /**< Values necessary to define the boundary condition

/* ///////////////////////////////////////////////////////////////////// */
/* MODIFICATA DA EMA PER TESTARE DIFFUSIONE DI B IN DIREZIONE Z IN COORDINATE CILINDRICHE CON ADI
*/
/* ///////////////////////////////////////////////////////////////////// */
#include "pluto.h"
 ...
 *********************************************************************** */
{
  ...
  double Bpeak_g = 200.0;
  double sigma0_cm = 0.1;
  ...
  /* ----------------------------------------------------
      TEST BPHI DIFFUSION
    ----------------------------------------------------- */
  us[iBPHI] = Bpeak_g/unit_Mfield * exp(-x2*x2/(2*(sigma0_cm*sigma0_cm/UNIT_LENGTH/UNIT_LENGTH)));
